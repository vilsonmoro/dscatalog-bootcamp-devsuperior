...
create table tb_product (id int8 generated by default as identity, date TIMESTAMP WITHOUT TIME ZONE, description TEXT, img_url varchar(10000), name varchar(255), price float8, primary key (id));
